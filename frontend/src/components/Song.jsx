                ...
                <div>
                    <h3>{props._key + 1}</h3>
                    {
                        songPlayerInfo?.currentSong?.item?.id === props.data.id ? (
                            <>
                                <img className={songPlayerInfo?.isPlaying ? (`w-[25px]`) : (``)} src={songPlayerInfo?.isPlaying ? (`https://m.media-amazon.com/images/G/01/digital/music/player/web/EQ_accent.gif`) : (props.data.image[0].link)} alt="" />
                                <div>
                                    <p className="text-sm font-bold text-green-400">{props.data.name}</p>
                            ...
                            <>
                                ...
                                <div>
                                    <p className="text-sm font-bold text-white">{props.data.name}</p>
