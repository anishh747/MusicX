  ...
  return (
    <>
      <div className="flex items-center justify-center min-h-screen bg-gray-700">
        <div className="relative flex flex-col m-6 space-y-8 bg-gray-400 shadow-2xl rounded-2xl md:flex-row md:space-y-0">
          <form
            className="flex flex-col justify-center p-8 md:p-14"
            onSubmit={handleSubmit}
          >
            <span className="mb-3 text-4xl font-bold">Register</span>
            <span className="font-light text-gray-400 mb-8">Join us to</span>
            ...
            <div className="py-4">
              <label htmlFor="Confirm_password" className="mb-2 text-md">
                Confirm Password
              </label>
              <input
            ...
            <div className="text-md flex justify-center items-center">
              ...
              <Link
                to={"/login"}
                className="text-white hover:underline space-x-3 font-bold"
              >
                Login
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute top-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white font-bold items-center">
              <div className="text-l font-thin">
                All your favourite song in one place
              </div>
            </div>
